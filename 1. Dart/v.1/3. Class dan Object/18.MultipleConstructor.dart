...
void main() {
  ...
  print('------------------');
  //Dibawah adalah tambahan materi Multiple Constructor
  RekeningBank rekeningWew = new RekeningBank(
    namaPemilik: 'Wew wow',
    saldo: 20000,
  );
  print(rekeningWew.getBank);
}
...
class RekeningBank {
  ...
  //contoh Multiple Constructor dibawah
  RekeningBank.wew({this.namaPemilik, this.namaBank = 'wew', this.saldo});
